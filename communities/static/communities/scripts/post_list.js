(function() {
    ...
    function find_sorting_icons() {
        var res = {};
        res['published_at'] = document.getElementById('date-range-widget').getElementsByClassName('filter__sorting-icon')[0];
        res['views'] = document.getElementById('views-range-widget').getElementsByClassName('filter__sorting-icon')[0];
        res['post_likes_per_view'] = document.getElementById('likes-range-widget').getElementsByClassName('filter__sorting-icon')[0];
        return res;
    }
